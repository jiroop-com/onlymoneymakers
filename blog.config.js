...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://business.jiroop.com', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    'business jiroop, news, blog, business, marketing, entrepreneurship, commerce, finance', // 网站关键词 英文逗号隔开
